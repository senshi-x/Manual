...
* If you missed a message or announcement, like the result of a map vote, you can view them again by holding Tab, right clicking once and left clicking the **Notifications tab**.
...
* When a player is **dead** \(commonly reffered to as dead-dead\), he will not be not revivable and black screen with an appropriate message will be displayed instead of seeing their surroundings.
...
{% note %}
Resupplying is **not instant** but takes a few seconds, depending on the ammo source, as well as the amount of ammo you need to resupply. 

Additionally if you're not rearming, confirm that the Light/Heavy supply crate is indeed yours, rearming from **enemy supply crates** is not possible.
{% endnote %}
...
Just like rearming, requesting kits from crates will deplete the supply crates. Each kit will cost 200 points, with light crates having 1500 \(7x kits\) and heavy ones 3000 \(15x kits\).
